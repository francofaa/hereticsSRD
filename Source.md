...
| 5   | Weather              | WIL   | Today, take +1 when you roll with +wil.                                                   | A storm fills a 10' radius sphere for *dice* rounds. Creatures in the area must save vs your wil def or suffer *sum* lightning damage from the storm. Winds are deafening. Hail causes difficult terrain. | 1: You become a cloud for *dice* rounds, unable to do anything else. 2: Whenever you cast a spell, lightning strikes a creature within 100 feet at random for 3d6 lightning damage. 3: You become a hurricane. You roam the world forever, causing destruction.                                                                                                                                                                           |
| 6   | Fortune              | WIL   | Today, You may turn any roll into a 20 once.                                              | The number *sum* becomes a critical failure when rolled on the d20. If *sum* is greater than 20, 20 is now a critical failure. This effect lasts until the next dawn.                                     | 1: Remove 1 omen from yourself. Give it to another heretic, or it is assigned at random. This does not force an omen roll. 2: Whenever you roll a 20, it is a critical failure. 3: Your spell escapes and replaces you. You are pulled into the object the spell was cast from. You become a spell.                                                                                                                                       |
...
Build out the mishaps and dooms tables as you create the aspects and mark them down on the [Party](Party) document. All heretics will suffer from these mishaps and dooms. 
...
| --- | ---------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1   | Cards      | A deck of cards is shuffled. A question is spoken. The cards provide an answer                                                                                                           |
...
| 6   | Carvings   | The question is carved into bones, wood, or other hardy material that can be burned without being destroyed. Extreme heat is applied. The cracks around the question provide the answer. |
