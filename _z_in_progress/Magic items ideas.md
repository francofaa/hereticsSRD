...
- Bonecrusher. +1 warhammer. With this weapon, your critical range expands by 1 on each side. This means you critically succeed on a 20 and 19 and critically fail on a 1 and 2. Additionally, if your critical range is already expanded (like if you have a boon that grants critical hits on a 19), you also get critical hits on an 18, but you also critically fail on a 2. On a critical hit, this weapon does an additional 2d12 damage. On a critical miss, this weapon is embedded in a surface and requires an action to remove.
